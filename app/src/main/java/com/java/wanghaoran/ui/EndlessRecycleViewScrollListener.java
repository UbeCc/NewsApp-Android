...
public class EndlessRecycleViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    public EndlessRecycleViewScrollListener(LinearLayoutManager layoutManager, OnLoadMoreListener onLoadMore) {//这个函数来自2022年科协暑培的代码
        this.mLayoutManager = layoutManager;
        this.onLoadMore = onLoadMore;
    }

    public EndlessRecycleViewScrollListener(GridLayoutManager layoutManager, OnLoadMoreListener onLoadMore) {//这个函数来自2022年科协暑培的代码
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
        this.onLoadMore = onLoadMore;
    }

    public EndlessRecycleViewScrollListener(StaggeredGridLayoutManager layoutManager, OnLoadMoreListener onLoadMore) {//这个函数来自2022年科协暑培的代码
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
        this.onLoadMore = onLoadMore;
    }
